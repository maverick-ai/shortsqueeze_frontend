      ...
      <div className="SupportPaddingTop">
        ...
        <div className="container-lg SupportSubPaddingTop">
          ...
          <h2 className="SupportSubSubHeading d-flex justify-content-center">
            ...
            https://shortsqueeze.space (the “Site”).
          </h2>
          <h2 className="SupportSubSubHeading d-flex justify-content-center">
          ...
          <h2 className="SupportSubSubHeading d-flex justify-content-center">
            ...
            (including credit card numbers (which is not saved with us), email
          ...
          <h2 className="SupportSubSubHeading d-flex justify-content-center">
            ...
            Information, as described above. For example, we use Shopify to
            power our online store--you can read more about how Shopify uses
          ...
          <h2 className="SupportSubSubHeading d-flex justify-content-center">
            ...
            us by e-mail at hi@shortsqueeze.space or by mail using the details
            provided below: HIG-419, E-7, Arera Colony, Bhopal, MP, 462016,
            India
          </h2>
        </div>
      </div>
