      ...
      <div className="SupportPaddingTop">
        ...
        <div className="container-lg SupportSubPaddingTop">
          ...
          <h2 className="SupportSubSubHeading d-flex justify-content-center">
            This website is operated by SHORTSQUEEZE PRIVATE LIMITED. Throughout
            the site, the terms “we”, “us” and “our” refer to SHORTSQUEEZE
            PRIVATE LIMITED. SHORTSQUEEZE PRIVATE LIMITED offers this website,
          ...
          <h2 className="SupportSubSubHeading d-flex justify-content-center">
            ...
            SHORTSQUEEZE PRIVATE LIMITED, our directors, officers, employees,
          ...
          <h2 className="SupportSubSubHeading d-flex justify-content-center">
            You agree to indemnify, defend and hold harmless SHORTSQUEEZE
          ...
          <h2 className="SupportSubSubHeading d-flex justify-content-center">
            ...
            accordance with the laws of HIG-419, E-7, Arera Colony, Bhopal, MP,
            462016, India.
          </h2>
          <h2 className="SupportSubSubHeading d-flex justify-content-center">
